function [tau_s_h, tau_s_v, q_s_v, q_s_h, axial_stress_h, axial_stress_v, V_z_h, V_y_v] = Concept1new(Airfoil_w, y_interp_h, L_h_interp, y_interp, L_v_interp, t_v, t_h, span_v, span_h, C_r_v, C_r_h)
...
fprintf('The ultimate shear stress in the horizontal tail spar web is %.2f MPa\n', ult_tau_h_spar/1e6);
fprintf('The ultimate shear stress in the vertical tail spar web is %.2f MPa\n', ult_tau_v_spar/1e6);
...
fprintf('The ultimate compressive stress in the horizontal tail spar is %.2f MPa\n', ult_ax_str_comp_spar_h/1e6);
fprintf('The ultimate tensile stress in the horizontal tail spar is %.2f MPa\n', ult_ax_str_tens_spar_h/1e6);
fprintf('The ultimate compressive stress in the vertical tail spar is %.2f MPa\n', ult_ax_str_comp_spar_v/1e6);
fprintf('The ultimate tensile stress in the vertical tail spar is %.2f MPa\n', ult_ax_str_tens_spar_v/1e6);
